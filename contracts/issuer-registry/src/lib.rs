...
use earnproof_shared::{
    ApprovalQuery, ApprovalStatus, ContractError, IssuerError, IssuerRecord, IssuerStatus,
    MigrationStatus, PauseScope, TtlStatus, UpgradeApproval, UpgradeApprovalMetadata,
